...
export let message = null;         // Create a message of your choice

// Number examples
export let temperature = 72.6;
export let score = null;          // Add a number for a game score

// Boolean examples
export let isRaining = false;
export let isSunny = null;        // Set this to true or false based on your weather
...
export let fullName = null;       // Combine firstName and lastName

// Number operations
export let num1 = 10;
export let num2 = 5;
export let sum = null;           // Add num1 and num2
export let product = null;       // Multiply num1 and num2
...
export let radius = 5;
export let circleArea = null;    // Calculate the area of a circle (pi * radius * radius)
...
export let convertedNumber = null;    // Convert stringNumber to a number using Number()

export let numberToString = 123;
export let convertedString = null;    // Convert numberToString to a string using String()
...
export let totalPrice = null;         // Calculate the total price
